//Initial References
let imageContainer = document.getElementById("image-zoom-container");
...
function changeImage(element) {
  var lowResSrc = element.getAttribute("src");
  var highResSrc = lowResSrc.replace('_min.png', '.png');
  var mainImage = document.getElementById("mainImage");
  var zoomOverlay = document.getElementById("zoom-overlay");
  var text = element.alt;

  document.getElementById("magnifyText").innerText = text;
  zoomOverlay.style.backgroundImage = "url('" + highResSrc + "')";
